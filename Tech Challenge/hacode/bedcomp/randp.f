...
! 
 ...
 209    format(a4,1x,a4)
        ...
        call dataout(cromo,line,intl,
     x        intr,nfile,ltotal,imod)
...
!
 ...
 201    format(10x," file has ",i15," lines of data ")
        ...
        subroutine dataout(cromo,nline,intl,
     x                  intr,nfile,ltotal,imod)
        ...
        do jj=1,nline
         if( jj .lt. nline ) then
          if( intr(jj)+imod+10 .lt. intl(jj+1) ) then
           intr(jj) = intr(jj)+imod
          endif
         endif
